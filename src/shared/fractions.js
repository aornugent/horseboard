 ...
 *
 * @param {number|null} value - The numeric value (null or 0 returns empty string)
 * @param {string} [unit] - Optional unit to append for non-fraction values
 * @returns {string} Formatted string (e.g., "2½", "¾", "1.6 scoops", or "")
 */
 ...
 *
 * @param {string} input - Formatted string (e.g., "2½", "¾", "1.5")
 ...
 */
export function getFractionPresets() {
  return [
    { value: 0.25, label: '¼' },
    { value: 0.5, label: '½' },
    { value: 0.75, label: '¾' },
